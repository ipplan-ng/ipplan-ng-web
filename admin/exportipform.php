...
insert($w,text(my_("Export IP details data to flat ascii files.  The file will contain six columns each delimited by TAB. The columns are exported in the following order: ")));

insert($w,text(my_("IP address, user, location, description, hostname, telephone number and mac address.")));
